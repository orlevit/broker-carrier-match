...
from config import APETITE_SYSTEM_PROMPT, APETITE_BASE_USER_PROMPT
...
class AppetiteGuideVectorDB:
    ...
    def create_hierarchical_chunks(
        ...
        # Extract metadata for the full guide
        self.logger.info("Extracting metadata for the full guide: %s", carrier_name)
        full_guide_metadata_part = self.opeani_api.extract_metadata_with_openai(full_guide, carrier_name)

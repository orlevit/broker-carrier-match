...
class AppetiteGuideVectorDB:
    ...
    def create_hierarchical_chunks(self, sections: List[Dict[str, Any]], 
                                  carrier_name: str) -> List[Dict[str, str]]:
        """
        ...
        # First, add each complete section as a chunk
    ...
    def process_guide(self, guide_data: Dict[str, str]) -> List[Dict[str, str]]:
        ...
        chunks = self.create_hierarchical_chunks(sections, carrier_name)
    ...
    def build(self, file_path: str) -> None:
        ...
        print(f"Vector database created with {len(chunks)} chunks using {self.model_name} embeddings")

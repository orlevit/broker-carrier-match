...
"section": dictionary of section numbers to section names ONLY from this text (or null if not present),
"geographical_region": {{
...
"""
        ...
        try:
            ...
            try:
                ...
                for key in ["section", "geographical_region", "coverage", "capacity", "limit", "Natural_disaster"]:
                    if key not in metadata or metadata[key] is None:
                        if key in ["section"]:
                            metadata[key] = {}
                        elif key in ["coverage", "capacity", "limit"]:
                            metadata[key] = None
